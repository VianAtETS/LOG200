...
Welcome to the **LOG200** repository! This repository was generated from a template to get you started quickly.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/VianAtETS/LOG200.git
   cd LOG200
   ```
